...
func (h ERC20TransactionHandler) BuildUnsignedTransaction (fromAddress, toAddress string, amount *big.Int, args ...interface{}) (transaction interface{}, digests []string, err error) {
	...
	digests = append(digests, hash.Hex())
	return
}
